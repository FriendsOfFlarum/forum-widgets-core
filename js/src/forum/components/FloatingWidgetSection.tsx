 ...
 *
 * Unlike the other sections this is not tied to the index page: `forum/index`
 * mounts it on its own root on the document body so it is present everywhere and
 * its open/closed state (and each widget's loaded content) survives SPA
  ...
  view(): Mithril.Children {
    ...
    return (
      ...
      >
        ...
        >
          {icon(this.open ? 'fas fa-chevron-down' : 'fas fa-layer-group')}
        </button>
      </div>
    );
  }
