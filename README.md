<p align=center><img width=100 src="https://raw.githubusercontent.com/FriendsOfFlarum/forum-widgets-core/master/icon.svg" alt="icon"></p>
<h1 align=center>Forum Widgets</h1><p align=center>
<img alt="License" src="https://img.shields.io/badge/license-MIT-blue.svg?style=flat-square"> <a href="https://packagist.org/packages/fof/forum-widgets-core"><img alt="Latest Stable Version" src="https://img.shields.io/packagist/v/fof/forum-widgets-core.svg?style=flat-square"></a> <a href="https://packagist.org/packages/fof/forum-widgets-core"><img alt="Total Downloads" src="https://img.shields.io/packagist/dt/fof/forum-widgets-core.svg?style=flat-square"></a>
</p><p align=center>
...
export default class MyWidget extends Widget {
  className() {
    // Custom class name.
    // You can also use the class "FofWidgets-Widget--flat" for a flat widget (not contained in a block).
